...
import LessonContent5 from '@/components/lesson/LessonContent5';
    ...
    <div className="py-8 sm:py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">ドキュメント: 挿入ソート</h1>
          <p className="mt-4 text-lg text-gray-400">適切な位置に挿入して整列</p>
        </div>
        ...
        <div className="mt-12 text-center space-y-4">
          ...
          <div>
            <Link href="/application/base2/5/problems" className="inline-block px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors shadow-lg hover:shadow-blue-500/30 transform hover:-translate-y-0.5">
                問題集に進む &rarr;
            </Link>
          </div>
        </div>
