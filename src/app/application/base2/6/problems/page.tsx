...
import LessonContent6 from '@/components/lesson/LessonContent6';
...
export default function RecursionProblemsPage() {
  ...
  return (
    <ProblemPageLayout
      ...
      documentTitle="ドキュメント: 再帰"
      lessonPath={lessonPath}
      nextLessonLink="/application"
      nextLessonTitle="基礎IIを完了し、コース選択に戻る"
      lessonContent={<LessonContent6 />}
    >
      {/* Problem 1 */}
