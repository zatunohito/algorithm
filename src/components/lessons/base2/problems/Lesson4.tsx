    ...
    <>
      ...
      <div className="p-6 bg-gray-900/60 rounded-lg border border-gray-800">
        ...
        <details className="mt-4 group">
          ...
          <div className="mt-2 pt-4 border-t border-gray-700 text-gray-300">
            <p><strong>答え:</strong> `[1, 8, 2, 6, 5]`</p>
            <p className="mt-2"><strong>理由:</strong> 1回目のパスでは、未整列部分（配列全体）から最小値を探します。最小値は `1`（インデックス4）です。これと未整列部分の先頭要素 `5`（インデックス0）を交換します。その結果、配列は `[1, 8, 2, 6, 5]` となります。</p>
          </div>
        </details>
      </div>
      ...
      <div className="p-6 bg-gray-900/60 rounded-lg border border-gray-800">
        ...
        <details className="mt-4 group">
          <summary className="cursor-pointer text-blue-400 hover:text-blue-300 list-none group-open:text-white">答えを見る</summary>
          <div className="mt-2 pt-4 border-t border-gray-700 text-gray-300">
            <p><strong>答え:</strong> `[1, 2, 8, 6, 5]`</p>
            <p className="mt-2"><strong>理由:</strong> 2回目のパスでは、未整列部分（インデックス1以降 `[8, 2, 6, 5]`）から最小値を探します。最小値は `2`（元のインデックス2）です。これと未整列部分の先頭要素 `8`（インデックス1）を交換します。その結果、配列は `[1, 2, 8, 6, 5]` となります。</p>
          </div>
        </details>
      </div>
      ...
      <div className="p-6 bg-gray-900/60 rounded-lg border border-gray-800">
        ...
        <details className="mt-4 group">
          <summary className="cursor-pointer text-blue-400 hover:text-blue-300 list-none group-open:text-white">答えを見る</summary>
          <div className="mt-2 pt-4 border-t border-gray-700 text-gray-300">
            <p><strong>答え:</strong> n-1 回</p>
            <p className="mt-2"><strong>理由:</strong> 選択ソートは、1回のパス（外側のループ1周）で最小値（または最大値）を見つけた後、交換を1回だけ行います。このパスは `n-1` 回繰り返されるため、交換回数も最大で `n-1` 回となります。これは、比較回数が多い一方で交換回数が少ないという、選択ソートの重要な特性です。</p>
          </div>
        </details>
      </div>
    </>
