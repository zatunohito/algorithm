    ...
    <>
      ...
      <div className="p-6 bg-gray-900/60 rounded-lg border border-gray-800">
        ...
        <details className="mt-4 group">
          ...
          <div className="mt-2 pt-4 border-t border-gray-700 text-gray-300">
            ...
            <p className="mt-2"><strong>理由:</strong> 配列を先頭から順番に見ていくと、`15` (インデックス0), `7` (インデックス1), `22` (インデックス2), `13` (インデックス3) となり、4番目（インデックス3）で値が見つかります。</p>
          </div>
        </details>
      </div>
      ...
      <div className="p-6 bg-gray-900/60 rounded-lg border border-gray-800">
        ...
        <details className="mt-4 group">
          <summary className="cursor-pointer text-blue-400 hover:text-blue-300 list-none group-open:text-white">答えを見る</summary>
          <div className="mt-2 pt-4 border-t border-gray-700 text-gray-300">
            <p><strong>答え:</strong> `data[i] が target と等しい`</p>
            <p className="mt-2"><strong>理由:</strong> 線形探索では、ループで配列の各要素 `data[i]` を取り出し、探している値 `target` と一致するかどうかを比較します。したがって、条件式にはこの比較が入ります。</p>
          </div>
        </details>
      </div>
    </>
