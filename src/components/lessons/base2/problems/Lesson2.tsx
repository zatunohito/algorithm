    ...
    <>
      ...
      <div className="p-6 bg-gray-900/60 rounded-lg border border-gray-800">
        ...
        <details className="mt-4 group">
          ...
          <div className="mt-2 pt-4 border-t border-gray-700 text-gray-300">
            <p><strong>答え:</strong> 配列がソート（整列）されていること。</p>
            <p className="mt-2"><strong>理由:</strong> 二分探索は、探索範囲の中央値と目的値を比較し、大小関係に基づいて探索範囲を半分に絞り込むことで機能します。この大小比較が意味を持つためには、データが昇順または降順に並んでいる必要があります。</p>
          </div>
        </details>
      </div>
      ...
      <div className="p-6 bg-gray-900/60 rounded-lg border border-gray-800">
        ...
        <details className="mt-4 group">
          <summary className="cursor-pointer text-blue-400 hover:text-blue-300 list-none group-open:text-white">答えを見る</summary>
          <div className="mt-2 pt-4 border-t border-gray-700 text-gray-300">
            <p><strong>答え:</strong> 3</p>
            <p className="mt-2"><strong>理由:</strong> 最初の探索範囲は `left = 0`, `right = 6` です。中央のインデックスは `mid = floor((0 + 6) / 2) = floor(3) = 3` となります。したがって、最初に比較されるのは `data[3]` (値は40) です。</p>
          </div>
        </details>
      </div>
      ...
      <div className="p-6 bg-gray-900/60 rounded-lg border border-gray-800">
        ...
        <details className="mt-4 group">
          <summary className="cursor-pointer text-blue-400 hover:text-blue-300 list-none group-open:text-white">答えを見る</summary>
          <div className="mt-2 pt-4 border-t border-gray-700 text-gray-300">
            <p><strong>答え:</strong> `left` が `4` になり、`right` は `6` のまま。</p>
            <p className="mt-2"><strong>理由:</strong> 目的の値 `60` は比較対象の `40` より大きいため、探索範囲は右半分に絞られます。アルゴリズムに従い、`left` が `mid + 1` (つまり `3 + 1 = 4`) に更新されます。`right` は変わりません。</p>
          </div>
        </details>
      </div>
    </>
